...
![End-to-end remote EV maintenance framework from vehicle state and onboard classification through 5G connectivity to remote maintenance and maintenance action](docs/assets/system-architecture.png)
