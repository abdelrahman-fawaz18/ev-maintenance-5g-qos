...
> **Result.** At 40 Mbps of competing EV uplink load, QoS-aware scheduling increased ALERT delivery by **11.88 percentage points** and FAULT delivery by **37.47 percentage points**. It reduced loss-penalized mean delay by **1,439 ms** and **987 ms**, respectively. These are matched-seed effects from 50 paired realizations; the routine DIAG flow remained best effort in both policies.
